...
class DetailViewController: UIViewController {
    ...
    private struct Texts {
        ...
        static let display: [(String, [DetailCellType])] = [("BRIGHTNESS", [DetailCellType.Slider]),("",[DetailCellType.Navigable(title: "Night Shift", detail: "Off")]),("",[DetailCellType.Navigable(title: "Auto-Lock", detail: "1 Minute")]),("",[DetailCellType.Navigable(title: "Text Size", detail: ""),DetailCellType.Switch(title: "Bold Text")]),("DISPLAY ZOOM",[DetailCellType.Navigable(title: "View", detail: "Standard")])]
        static let bluetooth: [(String, [DetailCellType])] = [("",[DetailCellType.Switch(title: "Bluetooth")])]
        static let mobileData: [(String, [DetailCellType])] = [("",[DetailCellType.Switch(title: "Mobile Data"),DetailCellType.Navigable(title: "Mobile Data Options", detail: "Roaming On"),DetailCellType.Text(detail: "Turn off mobile data to restrict all data to Wifi, including email, web browsing, and push notifications.")])]
        static let notification: [(String, [DetailCellType])] = [("",[DetailCellType.Switch(title: "Notification")])]
        static let doNotDisturb: [(String, [DetailCellType])] = [("",[DetailCellType.Switch(title: "Do Not Disturb"),DetailCellType.Text(detail: "When Do Not Disturb is enabled, calls and alerts that arrive while locked will be silenced, and a moon icon will appear in the status bar.")])]
